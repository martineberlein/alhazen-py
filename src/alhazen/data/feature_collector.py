...
from alhazen.data.features import Feature, FeatureWrapper, STANDARD_FEATURES
...
class Collector:
    ...
    def collect_features_from_list(self, test_inputs: Set[AlhazenInput]) -> pandas.DataFrame:
        data = []
    ...
    def collect_features(self, test_input: AlhazenInput) -> Dict:
        # assert isinstance(
        #     test_input.tree, list
