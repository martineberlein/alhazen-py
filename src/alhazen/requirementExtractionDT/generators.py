...
class ReachTargetGenerator(SampleGenerator):
    ...
    def _run_specs(
        self, feature_file: Path, iter_dir: Path, all_reqs: List[str]
    ) -> None:
        # output spec
    ...
    def _generate_samples(
        self, spec_file: Path, feature_file: Path, iter_dir: Path
    ) -> None:
        """
